...
function App() {
  ...
  useEffect(() => {
    ...
    const handleKey = (e) => {
      ...
      if (e.key === 'ArrowRight' || e.key === 'PageDown') goForwardRef();
      else if (e.key === 'ArrowLeft' || e.key === 'PageUp') goBackRef();
    };
              ...
              <div className="skills-box">
                <div className="skills-content">
                  ...
                  <div className="content">
                    ...
                    <span>
                      <i className="bx bxl-nodejs" />Express JS
                    </span>
                     <span>
                      <i className="bx bxl-mongodb" />mangoDB
                    </span>
                    <span>
                    ...
                    <span>
                      <i className="bx bxl-mysql" />MySql
                    </span>
                    <span>
                      <i className="bx bxl-data" />Oracle SQL
                    </span>
                    <span>
                      <i className="bx bxl-mysql" />SqLite
                    </span>
                    <span>
                      <i className="bx bxl" />AuthZ and AuthN 
                    </span>
                    <span>
                      <i className="bx bxl" />Responsive web design
                    </span>
                    <span>
                      <i className="bx bxl" />Generative AI
                    </span>
                    <span>
                      <i className="bx bxl" />NLP
                    </span>
                    <span>
                      <i className="bx bxl" />Machine Learning
                    </span>
                  </div>
                </div>
              </div>
